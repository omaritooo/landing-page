export const ButtonApple = () => {
  return (
    <button className="flex min-w-[40vw] xs:min-w-[157px] min-h-[57px] group px-3 xs:px-6 py-1 xs:py-3 items-center rounded-2xl border-[1px] border-white-2 justify-between gap-x-2">
      متجر ابل
      <svg
        width="32"
        height="32"
      ...
      >
        <path
          className="text-white transition duration-150 group-hover:text-black"
